...
#define __PYX_HAVE__polylearn__cd_linear_fast
#define __PYX_HAVE_API__polylearn__cd_linear_fast
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
#define __Pyx_MODULE_NAME "polylearn.cd_linear_fast"
int __pyx_module_is_main_polylearn__cd_linear_fast = 0;

/* Implementation of 'polylearn.cd_linear_fast' */
...
static PyObject *__pyx_pf_9polylearn_14cd_linear_fast__cd_linear_epoch(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_w, struct __pyx_obj_9lightning_4impl_12dataset_fast_ColumnDataset *__pyx_v_X, PyArrayObject *__pyx_v_y, PyArrayObject *__pyx_v_y_pred, PyArrayObject *__pyx_v_col_norm_sq, double __pyx_v_alpha, struct __pyx_obj_9polylearn_9loss_fast_LossFunction *__pyx_v_loss); /* proto */
...
/* "polylearn/cd_linear_fast.pyx":16
 * 
 * 
...
static double __pyx_f_9polylearn_14cd_linear_fast__cd_linear_epoch(PyArrayObject *__pyx_v_w, struct __pyx_obj_9lightning_4impl_12dataset_fast_ColumnDataset *__pyx_v_X, PyArrayObject *__pyx_v_y, PyArrayObject *__pyx_v_y_pred, PyArrayObject *__pyx_v_col_norm_sq, double __pyx_v_alpha, struct __pyx_obj_9polylearn_9loss_fast_LossFunction *__pyx_v_loss, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_ii;
  ...
  __pyx_pybuffernd_col_norm_sq.rcbuffer = &__pyx_pybuffer_col_norm_sq;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_w.rcbuffer->pybuffer, (PyObject*)__pyx_v_w, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_y.rcbuffer->pybuffer, (PyObject*)__pyx_v_y, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_y.diminfo[0].strides = __pyx_pybuffernd_y.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_y.diminfo[0].shape = __pyx_pybuffernd_y.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_y_pred.rcbuffer->pybuffer, (PyObject*)__pyx_v_y_pred, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_col_norm_sq.rcbuffer->pybuffer, (PyObject*)__pyx_v_col_norm_sq, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  /* "polylearn/cd_linear_fast.pyx":25
 * 
 *     cdef int i, j, ii
 ...
 */
  ...
  /* "polylearn/cd_linear_fast.pyx":27
 *     cdef double sum_viol = 0
 *     cdef int n_features = w.shape[0]
 *     cdef double update = 0             # <<<<<<<<<<<<<<
 *     cdef double inv_step_size
 ...
 */
  ...
  /* "polylearn/cd_linear_fast.pyx":35
 *     cdef int n_nz
 * 
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "polylearn/cd_linear_fast.pyx":36
 * 
 *     for j in range(n_features):
 *         X.get_column_ptr(j, &indices, &data, &n_nz)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "polylearn/cd_linear_fast.pyx":39
 * 
 *         # compute gradient with respect to w_j
 ...
 */
    ...
    for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
      ...
      /* "polylearn/cd_linear_fast.pyx":40
 *         # compute gradient with respect to w_j
 *         for ii in range(n_nz):
 *             i = indices[ii]             # <<<<<<<<<<<<<<
 *             update += loss.dloss(y_pred[i], y[i]) * data[ii]
 ...
 */
      __pyx_t_5 = __pyx_v_i;
      __pyx_t_6 = __pyx_v_i;
      __pyx_v_update = (__pyx_v_update + (((struct __pyx_vtabstruct_9polylearn_9loss_fast_LossFunction *)__pyx_v_loss->__pyx_vtab)->dloss(__pyx_v_loss, (*__Pyx_BufPtrStrided1d(double *, __pyx_pybuffernd_y_pred.rcbuffer->pybuffer.buf, __pyx_t_5, __pyx_pybuffernd_y_pred.diminfo[0].strides)), (*__Pyx_BufPtrStrided1d(double *, __pyx_pybuffernd_y.rcbuffer->pybuffer.buf, __pyx_t_6, __pyx_pybuffernd_y.diminfo[0].strides))) * (__pyx_v_data[__pyx_v_ii])));
    }
 ...
 */
    ...
    /* "polylearn/cd_linear_fast.pyx":48
 *         update /= inv_step_size
 * 
 *         w[j] -= update             # <<<<<<<<<<<<<<
 ...
 */
    __pyx_t_9 = __pyx_v_j;
    *__Pyx_BufPtrStrided1d(double *, __pyx_pybuffernd_w.rcbuffer->pybuffer.buf, __pyx_t_9, __pyx_pybuffernd_w.diminfo[0].strides) -= __pyx_v_update;

    /* "polylearn/cd_linear_fast.pyx":49
 * 
 *         w[j] -= update
 *         sum_viol += fabs(update)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "polylearn/cd_linear_fast.pyx":52
 * 
 *         # update predictions
 *         for ii in range(n_nz):             # <<<<<<<<<<<<<<
 *             i = indices[ii]
 ...
 */
    ...
    for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
      ...
      /* "polylearn/cd_linear_fast.pyx":53
 *         # update predictions
 *         for ii in range(n_nz):
 *             i = indices[ii]             # <<<<<<<<<<<<<<
 *             y_pred[i] -= update * data[ii]
 ...
 */
      ...
      /* "polylearn/cd_linear_fast.pyx":54
 *         for ii in range(n_nz):
 *             i = indices[ii]
 *             y_pred[i] -= update * data[ii]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      *__Pyx_BufPtrStrided1d(double *, __pyx_pybuffernd_y_pred.rcbuffer->pybuffer.buf, __pyx_t_10, __pyx_pybuffernd_y_pred.diminfo[0].strides) -= (__pyx_v_update * (__pyx_v_data[__pyx_v_ii]));
    }
  }

  /* "polylearn/cd_linear_fast.pyx":56
 *             y_pred[i] -= update * data[ii]
 * 
 *     return sum_viol             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __Pyx_WriteUnraisable("polylearn.cd_linear_fast._cd_linear_epoch", __pyx_clineno, __pyx_lineno, __pyx_filename, 0, 0);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_col_norm_sq.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_9polylearn_14cd_linear_fast_1_cd_linear_epoch(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_9polylearn_14cd_linear_fast_1_cd_linear_epoch(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_cd_linear_epoch (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_X)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_cd_linear_epoch", 1, 7, 7, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_y)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_cd_linear_epoch", 1, 7, 7, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_y_pred)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_cd_linear_epoch", 1, 7, 7, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_col_norm_sq)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_cd_linear_epoch", 1, 7, 7, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_alpha)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_cd_linear_epoch", 1, 7, 7, 5); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_loss)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_cd_linear_epoch", 1, 7, 7, 6); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_cd_linear_epoch") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_col_norm_sq = ((PyArrayObject *)values[4]);
    __pyx_v_alpha = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_alpha == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_loss = ((struct __pyx_obj_9polylearn_9loss_fast_LossFunction *)values[6]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_cd_linear_epoch", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("polylearn.cd_linear_fast._cd_linear_epoch", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_X), __pyx_ptype_9lightning_4impl_12dataset_fast_ColumnDataset, 1, "X", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_y_pred), __pyx_ptype_5numpy_ndarray, 1, "y_pred", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_col_norm_sq), __pyx_ptype_5numpy_ndarray, 1, "col_norm_sq", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_loss), __pyx_ptype_9polylearn_9loss_fast_LossFunction, 1, "loss", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyObject *__pyx_pf_9polylearn_14cd_linear_fast__cd_linear_epoch(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_w, struct __pyx_obj_9lightning_4impl_12dataset_fast_ColumnDataset *__pyx_v_X, PyArrayObject *__pyx_v_y, PyArrayObject *__pyx_v_y_pred, PyArrayObject *__pyx_v_col_norm_sq, double __pyx_v_alpha, struct __pyx_obj_9polylearn_9loss_fast_LossFunction *__pyx_v_loss) {
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_w.rcbuffer->pybuffer, (PyObject*)__pyx_v_w, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_w.diminfo[0].strides = __pyx_pybuffernd_w.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_w.diminfo[0].shape = __pyx_pybuffernd_w.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_y_pred.rcbuffer->pybuffer, (PyObject*)__pyx_v_y_pred, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_y_pred.diminfo[0].strides = __pyx_pybuffernd_y_pred.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_y_pred.diminfo[0].shape = __pyx_pybuffernd_y_pred.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
  ...
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_9polylearn_14cd_linear_fast__cd_linear_epoch(((PyArrayObject *)__pyx_v_w), __pyx_v_X, ((PyArrayObject *)__pyx_v_y), ((PyArrayObject *)__pyx_v_y_pred), ((PyArrayObject *)__pyx_v_col_norm_sq), __pyx_v_alpha, __pyx_v_loss, 0)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyMethodDef __pyx_methods[] = {
  {"_cd_linear_epoch", (PyCFunction)__pyx_pw_9polylearn_14cd_linear_fast_1_cd_linear_epoch, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initcd_linear_fast(void); /*proto*/
PyMODINIT_FUNC initcd_linear_fast(void)
#else
PyMODINIT_FUNC PyInit_cd_linear_fast(void); /*proto*/
PyMODINIT_FUNC PyInit_cd_linear_fast(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_cd_linear_fast(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cd_linear_fast", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_polylearn__cd_linear_fast) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "polylearn.cd_linear_fast")) {
      if (unlikely(PyDict_SetItemString(modules, "polylearn.cd_linear_fast", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "polylearn/cd_linear_fast.pyx":1
 * # encoding: utf-8             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init polylearn.cd_linear_fast", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init polylearn.cd_linear_fast");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
